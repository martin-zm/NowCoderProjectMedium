(function () {
    var h = {}, mt = {}, c = {
        id: "512065947708a980c982b4401d14c2f5",
        dm: ["toutiao.io"],
    ...
    (function () {
        ...
        var b = mt.url, f = mt.O, d = mt.P, e = mt.lang, m = mt.cookie, n = mt.j, g = mt.localStorage, k = mt.sessionStorage, l = h.w, v = h.G;
        a.prototype = {
            K: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                try {
                    m.set(a, b, {domain: this.I(), path: this.Q(), H: d}), d ? g.set(a, b, d) : k.set(a, b)
                } catch (e) {
                }
            }, Ca: function (a) {
                try {
                    m.set(a, "", {domain: this.I(), path: this.Q(), H: -1}), k.remove(a), g.remove(a)
                } catch (b) {
                }
            }, Ia: function () {
                var a, b, d, e, f;
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id), e = -1 < document.referrer.indexOf(l.ba), f = b.k(a, "jn"), g = /^heatlink$|^select$/.test(f);
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ya) && c.cvcc)) {
            var e, m, n, g, k = function (a) {
                ...
                g.v = a;
                if (f) {
                    var m = f.getAttribute("href"), k = f.getAttribute("onclick") ? "" + f.getAttribute("onclick") : t, l = f.getAttribute("id") || "";
